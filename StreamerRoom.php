       ...
       <div class="nav--list">
        ...
        <div id="nav__links">
            <?php if(isset($_SESSION['username'])): ?>
             <p class="u-small-text u-text u-text-variant u-text-1">UserName:<?php echo $_SESSION['username']?></p>
             <p class="u-small-text u-text u-text-variant u-text-1">Money:<?php echo $_SESSION['money']?></p>
            <?php endif ?>

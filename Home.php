          ...
          <div class="u-repeater u-repeater-1">
            <div class="u-container-style u-custom-item u-list-item u-radius-30 u-repeater-item u-shape-round u-video u-video-contain" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="" >
              <div class="u-background-video u-expanded" style="">
                <div class="embed-responsive embed-responsive-1">
                  ...
                  <div style="text-align: center; margin:50px; color:black; background-image: url(../images/shownamebackground.jpg); background-size:100% 100%;border-radius:10px;font-family: 'Lobster', cursive; "><?php echo $_SESSION['user1']?></div>
            ...
            <div class="u-container-style u-custom-item u-list-item u-radius-30 u-repeater-item u-shape-round u-video u-video-contain" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
              <div class="u-background-video u-expanded" style="">
                ...
                <div style="text-align: center; margin:50px; color:black; background-image: url(../images/shownamebackground.jpg); background-size:100% 100%;border-radius:10px;font-family: 'Lobster', cursive; "><?php echo $_SESSION['user2']?></div>
            ...
            <div class="u-container-style u-custom-item u-list-item u-radius-30 u-repeater-item u-shape-round u-video u-video-contain" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
              <div class="u-background-video u-expanded" style="">
                ...
                <div style="text-align: center; margin:50px; color:black; background-image: url(../images/shownamebackground.jpg); background-size:100% 100%;border-radius:10px;font-family: 'Lobster', cursive; "><?php echo $_SESSION['user3']?></div>
            ...
            <div class="u-container-style u-custom-item u-list-item u-radius-30 u-repeater-item u-shape-round u-video u-video-contain" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
              <div class="u-background-video u-expanded" style="">
                ...
                <div style="text-align: center; margin:50px; color:black; background-image: url(../images/shownamebackground.jpg); background-size:100% 100%;border-radius:10px;font-family: 'Lobster', cursive; "><?php echo $_SESSION['user4']?></div>                
            ...
            <div class="u-container-style u-custom-item u-list-item u-radius-30 u-repeater-item u-shape-round u-video u-video-contain" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
              <div class="u-background-video u-expanded" style="">
                ...
                <div style="text-align: center; margin:50px; color:black; background-image: url(../images/shownamebackground.jpg); background-size:100% 100%;border-radius:10px;font-family: 'Lobster', cursive; "><?php echo $_SESSION['user5']?></div>
